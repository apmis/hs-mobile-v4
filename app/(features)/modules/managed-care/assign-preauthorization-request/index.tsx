...
export default function AssignPreauthorizationRequestScreen() {
  return (
    <ManagedCareScreenWrapper title="Assign Preauthorization Request">
      <ThemedView style={{ flex: 1 }}>
        <ThemedText type="subtitle" style={{ padding: 16, textAlign: 'center' }}>
          Assign Preauthorization Request Chats
        </ThemedText>
        <ChatInterface />
      </ThemedView>
