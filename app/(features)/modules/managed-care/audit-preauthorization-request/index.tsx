...
export default function AuditPreauthorizationRequestScreen() {
  return (
    <ManagedCareScreenWrapper title="Audit Preauthorization Request">
      <ThemedView style={{ flex: 1 }}>
        <ThemedText type="subtitle" style={{ padding: 16, textAlign: 'center' }}>
          Audit Preauthorization Request Chats
        </ThemedText>
        <ChatInterface />
      </ThemedView>
